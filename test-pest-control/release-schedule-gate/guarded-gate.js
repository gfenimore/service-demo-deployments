/**
 * Release the day - Guarded Gate (contract compliant)
 * Blueprint ID: d0000000-0000-0000-0000-000000000001
 * Pattern: GUARDED-GATE
 * Gate: SCHEDULE.RELEASE.CONFIRM
 *
 * Contract:
...
(function () {
  ...
  var GATE = {
  "code": "SCHEDULE.RELEASE.CONFIRM",
  "title": "Release the day",
  "subject": "Releasing sends the day out: every work order on it is promised to its customer for the window the policy names, and locked. A move after this is an override by role.",
  "subjectName": {
    "source": "route",
    "key": "route_id",
    "field": "route_name"
  ...
  "verdicts": [
    {
      "code": "RELEASE",
      "label": "Release the day",
      "confirm": "Release this day? The promises go out and the work orders lock.",
      "endpoint": "rpc:release_schedule",
      "method": "POST",
      "payload": {
        "action": "release"
      },
      "consequence": "Moves the day to released with its stamp and every floating work order to scheduled through the scheduler, each with its promise.",
      "reaches": null,
      "tone": "primary",
      "next": {
        "route": "/operations/scheduling/:id",
        "title": "The day, released"
      },
      "argMap": {
        "p_by": "user_id",
        "p_route": "subject_id"
  ...
  class RouteGateUI {
    constructor() {
      ...
      this.metadata = {
        blueprint_id: 'd0000000-0000-0000-0000-000000000001',
  ...
  if (typeof window !== 'undefined') {
    ...
    window.PatternRegistry['d0000000-0000-0000-0000-000000000001'] = window.RouteGateUI;
  }

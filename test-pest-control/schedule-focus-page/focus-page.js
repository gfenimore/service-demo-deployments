/**
 * Route Focus Page - Generated Blueprint UI (THE ONE PAGE, focus-page-001 1.2.0)
 *
 ...
 * Blueprint ID: cd000000-0000-0000-0000-000000000001
...
(function() {
  ...
  var FACE = {"schema":"services_template","tray":{"kinds":{"pool":{"button":{"title":"Place the week","status":"future"}},"missed":{"button":{"title":"Resolve","status":"future"}},"proposal":{"button":{"title":"Accept","status":"future"}}},"source":"v_schedule_tray"},"verbs":[{"verb":"place_week","route":"/operations/scheduling/:id/place-week","title":"Place the week","scenario":"the PLACE phase (THE MACHINE 2.2, his C): the pool in ascending buffer over this day's week, each to its cheapest day unless leaving it is cheaper; the rest visible with a reason"},{"verb":"sequence","route":"/operations/scheduling/:id/sequence","title":"Sequence","scenario":"the SEQUENCE phase (his C and E): the stops ordered from the technician's start inside the customers' hour windows; the proposal accepted on the click"},{"verb":"release","route":"/operations/scheduling/:id/release","title":"Release","scenario":"the release act (concept 6; Q4): the day goes out, every floating work order scheduled with its promise per notice.scheduled"}],"entity":"route","header":{"chips":["status"],"title_field":"route_name"},"selectors":[{"key":"candidates","list":{"source":"v_schedule_candidates","columns":[{"field":"account","header":"account"},{"field":"buffer","header":"buffer"},{"field":"delta","header":"delta"},{"field":"terms","header":"terms"}],"order_by":"buffer"},"label":"Candidates"},{"key":"stops","list":{"source":"v_schedule_stops","columns":[{"field":"seq","header":"seq"},{"field":"eta","header":"eta"},{"field":"place","header":"place"},{"field":"work_orders","header":"work orders"}],"order_by":"seq"},"label":"Stops"},{"key":"runs","list":{"source":"v_schedule_runs","columns":[{"field":"at","header":"at"},{"field":"kind","header":"kind"},{"field":"summary","header":"summary"},{"field":"accepted_by","header":"accepted by"}],"order_by":"at desc"},"label":"Runs"},{"key":"promises","list":{"source":"v_schedule_promises","columns":[{"field":"account","header":"account"},{"field":"service","header":"service"},{"field":"promise","header":"promise"},{"field":"state","header":"state"}],"order_by":"promise"},"label":"Promises"}],"primary_key":"route_id","frame_columns":4,"personas":{"GENERIC_USER":{"fields":null,"readonly":[],"filters":null,"actions":["view","search","sort","filter"],"seated":false},"FIELD_TECH":{"fields":null,"readonly":[],"filters":{"status":["active"]},"actions":["close_stop","search","view","run_day"],"seated":false},"OPS_MANAGER":{"fields":["route_name","status","route_date","weekday","technician","template","state","room","placed","slack","minutes","released"],"readonly":[],"filters":null,"actions":["view","search","sort","filter","edit","create","cancel","defer","place","place_week","sequence","release"],"seated":true},"ADMIN_FULL":{"fields":null,"readonly":[],"filters":null,"actions":["view","search","sort","filter","edit","delete","export","bulk_actions","create","cancel","defer","place","place_week","sequence","release"],"seated":true},"CUSTOMER_SERVICE":{"fields":["route_name","status","route_date","weekday","technician","template","state","room","placed","slack","minutes","released"],"readonly":[],"filters":{"status":["active"]},"actions":["view","search","sort","filter","edit","log_call","schedule","cancel","defer","place"],"seated":true},"SERVICE_MANAGER":{"fields":["route_name","status","route_date","weekday","technician","template","state","room","placed","slack","minutes","released"],"readonly":[],"filters":{"status":["active"]},"actions":["view","search","sort","filter","schedule","assign_tech","create","cancel","defer","place","place_week","sequence","release"],"seated":true}}};
  var SKELETON = "<!-- Route Focus Page -- THE ONE PAGE (focus-page-001, screen-grammar 42-46; 1.2.0 THE RAIL). Generated; do not edit.\n     The shell mounts into an EMPTY host (the s37 skeleton lesson): this markup is written by\n     focus-page.js FIRST, then filled. Five regions less one: the call panel arrives with 3c.\n     1.2.0 (s51 rung 5a): the body splits into THE RAIL on the left (hidden unless the blueprint\n     declares one and the role holds a step) and the main column: the selectors, the frame, and\n     the lit step's body (its gate mounted in the frame). -->\n<div class=\"fp\" data-blueprint=\"cd000000-0000-0000-0000-000000000001\">\n  <header class=\"fp-head\">\n    <h2 class=\"fp-title\" data-fp=\"title\"></h2>\n    <span class=\"fp-chips\" data-fp=\"chips\"></span>\n    <span class=\"fp-verbs\" data-fp=\"verbs\"></span>\n  </header>\n  <p class=\"fp-scope\" data-fp=\"scope\" hidden></p>\n  <section class=\"fp-tray\" aria-label=\"Needs attention\">\n    <p class=\"fp-tray-label\">Needs attention</p>\n    <div data-fp=\"tray\"></div>\n  </section>\n  <div class=\"fp-body fp-body--norail\" data-fp=\"body\">\n    <nav class=\"fp-rail\" data-fp=\"rail\" aria-label=\"The acts, in order\" hidden></nav>\n    <div class=\"fp-main\">\n      <nav class=\"fp-selectors\" data-fp=\"selectors\" aria-label=\"Detail selectors\"></nav>\n      <section class=\"fp-frame\" aria-label=\"Detail\">\n        <p class=\"fp-caption\" data-fp=\"caption\"></p>\n        <div class=\"fp-radios\" data-fp=\"radios\"></div>\n        <p class=\"fp-siteline\" data-fp=\"siteline\" hidden></p>\n        <div class=\"fp-list\" data-fp=\"list\"></div>\n        <div class=\"fp-history\" data-fp=\"history\" hidden></div>\n      </section>\n      <section class=\"fp-step\" data-fp=\"step\" aria-label=\"The step\" hidden></section>\n    </div>\n  </div>\n</div>\n";
  ...
  class RouteFocusPageBlueprintUI {
    ...
    getMetadata() {
      return { blueprintId: 'cd000000-0000-0000-0000-000000000001', pattern: 'FOCUS-PAGE', entity: FACE.entity };
    }
  ...
  if (typeof window !== 'undefined') {
    window.RouteFocusPageBlueprintUI = RouteFocusPageBlueprintUI;
    window.PatternRegistry = window.PatternRegistry || {};
    window.PatternRegistry['cd000000-0000-0000-0000-000000000001'] = window.RouteFocusPageBlueprintUI;
  }
})();

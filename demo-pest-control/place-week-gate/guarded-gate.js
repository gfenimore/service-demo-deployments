...
(function () {
  ...
  var GATE = {
  "code": "SCHEDULE.PLACE.WEEK",
  "title": "Place the week",
  "subject": "The scheduler places every ready work order of this week on its cheapest day -- unless leaving it costs less, in which case it stays in the pool with its reason for you to decide. You massage the result; nothing is promised until you release a day.",
  "subjectName": {
    "source": "route",
    "key": "route_id",
    "field": "route_name"
  ...
  "verdicts": [
    {
      "code": "PLACE_WEEK",
      "label": "Place the week",
      "confirm": "Place the week from the pool? Each work order goes to its cheapest day; the rest stay visible with a reason.",
      "endpoint": "rpc:place_week",
      "method": "POST",
      "payload": {
        "action": "place_week"
      },
      "consequence": "Moves each placed work order to placed through the scheduler, a run row per placement with its delta and the cost of leaving; the days' slack falls.",
      "reaches": null,
      "tone": "primary",
      "next": {
